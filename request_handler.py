...
class HandleRequests(BaseHTTPRequestHandler): #inheriting here
    ...
    def do_POST(self):
        ...
        content_len = int(self.headers.get('content-length', 0)) #if there is a header called content length: grab it; if not: return 0
        post_body = self.rfile.read(content_len)
        response = f"received post request:<br>{post_body}" #print this string
        self.wfile.write(response.encode())
